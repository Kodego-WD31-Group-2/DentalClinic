...
<?php $__env->startSection('subcontent'); ?>
        ...
        <div class="text-center text-gray-800">
          <div class="block rounded-lg shadow-lg px-6 py-12 md:py-16 md:px-12" style="margin-top: 50px; background-color: hsla(0, 0%, 100%, 0.8);backdrop-filter: saturate(200%) blur(25px);">
            ...
            <p class="text-black text-lg text-justify-center">
              Welcome to Dental Smileville! We are a team of dedicated and skilled dental professionals,
              ...
              <div class="mb-6 lg:mb-0">
                <div class="bg-white block rounded-lg shadow-lg">
                  <div class="relative overflow-hidden bg-no-repeat bg-cover">
                    <img src="<?php echo e(file_exists(public_path('storage/' . $doctor->doctor_image)) ? asset('storage/' . $doctor->doctor_image) : asset($doctor->doctor_image)); ?>" class="w-full rounded-t-lg" />
                    <a href="/doctors/<?php echo e($doctor->doctor_id); ?>/view">
                  ...
                  <div class="p-6">
                    <h5 class="text-lg font-bold mb-4">Dr. <?php echo e($doctor->first_name); ?> <?php echo e($doctor->last_name); ?></h5>
                    <p class="text-black-500 mb-4"><?php echo e($doctor->specialty); ?></p>
                  </div>
                </a>
                </div>
              </div>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Web Dev Projects\Kodego\Capstone\DentalClinic\resources\views/pages/doctors.blade.php ENDPATH**/ ?>