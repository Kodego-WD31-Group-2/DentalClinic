...
$startDate = Carbon::now()->startOfMonth()->subMonths(2)->format('Y-m-d');
$endDate = Carbon::now()->endOfMonth()->addMonths(2)->format('Y-m-d');

$transactions = DB::table('transactions')
    ->select(DB::raw('DATE_FORMAT(transaction_date, "%Y-%m") as month'), 'payment_method', DB::raw('COUNT(*) as count'))
