...
class TransactionController extends Controller
{
    ...
    {
        // Retrieve the transaction from the database using the $transaction variable
        // which is automatically resolved by Laravel based on the URL parameter.

        // You can perform any logic you need here to manipulate or prepare the transaction data
