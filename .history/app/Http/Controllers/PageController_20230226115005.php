...
$transactions = DB::table('transactions')
    ...
    'cashCount' => $transactions->where('payment_method', 'Cash')->sum('count'),
    'creditCardCount' => $transactions->where('payment_method', 'Credit Card')->sum('count'),
    'debitCardCount' => $transactions->where('payment_method', 'Debit Card')->sum('count'),
    'paypalCount' => $transactions->where('payment_method', 'PayPal')->sum('count'),
    'otherCount' => $transactions->where('payment_method', 'Other')->sum('count'),
            'layout' => 'side-menu'
        ]);
    }
