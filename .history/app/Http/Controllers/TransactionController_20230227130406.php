...
class TransactionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('transactions.add-transaction', compact('fees'));
    }
    ...
    public function show($transaction_id)
{
    ...
    // Fetch the transaction with the given ID, or throw an exception if not found
    
    $transactionItemsCount = $transaction->transactionItems()->count();
    // Count the transaction items for the given transaction ID
    
    return view('transactions.transaction-detail', [
        'transaction' => $transaction,
        'transactionItemsCount' => $transactionItemsCount,
    ]);
    // Pass the transaction data and transaction items count to the transaction-detail view
}
