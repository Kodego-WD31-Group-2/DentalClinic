...
class TransactionController extends Controller
{
    public function index()
    {
        ...
        return view('transactions.transaction-list', compact('transactionItems'));
    }

    public function transactions()
    {
        $transactionItems = Transaction::all();
        return view('transactions.transaction-items', compact('transactions'));
    }
