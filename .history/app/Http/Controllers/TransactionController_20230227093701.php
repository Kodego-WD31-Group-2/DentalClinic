...
{
    $transaction = Transaction::with('transactionItems.feeSchedule')->findOrFail($transaction_id);
    // Fetch the transaction with the given ID, including its related transaction items and fee schedules, 
    // or throw an exception if not found
    
    return view('transactions.transaction-detail', [
        'transaction' => $transaction,
    ]);
    // Pass the transaction data to the transaction-detail view
}
