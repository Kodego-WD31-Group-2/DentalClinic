...
Route::get('/transactions/create', [BillingsController::class, 'create'])->name('transactions.create');
Route::post('/transactions', [BillingsController::class, 'store'])->name('transactions.store');
Route::get('/transaction-items', [BillingsController::class, 'TransactionItems')->name('transaction-items.index');
