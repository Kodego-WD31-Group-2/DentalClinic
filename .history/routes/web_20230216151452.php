...
Route::get('/billings/list', [AppointmentsController::class, 'index'])->name('billings-list');
Route::get('/billings/book-billing', [AppointmentsController::class, 'add'])->name('book-billing');
Route::post('/billings/store', [AppointmentsController::class, 'store'])->name('billings.store');
Route::get('/billings/{billing}', [AppointmentsController::class, 'show']);
Route::get('/billings/{billing}/edit', [AppointmentsController::class, 'edit']);
Route::put('/billings/{billing}', [AppointmentsController::class, 'update'])->name('billings.update');
Route::delete('/billings/{billing}', [AppointmentsController::class,'destroy']);
