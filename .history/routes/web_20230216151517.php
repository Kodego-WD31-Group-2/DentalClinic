...
Route::get('/billings/book-billing', BillingsController::class, 'add'])->name('book-billing');
Route::post('/billings/store', BillingsController::class, 'store'])->name('billings.store');
Route::get('/billings/{billing}', BillingsController::class, 'show']);
