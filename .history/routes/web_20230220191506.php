...
Route::get('/transactions/create', [TransactionItemController::class, 'create'])->name('transactions.create');
Route::post('/transactions', [TransactionItemController::class, 'store'])->name('transactions.store');
