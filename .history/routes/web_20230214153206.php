...
Route::get('/appointments/list', [PatientsController::class, 'index']);
Route::get('/appointments/add', [PatientsController::class, 'add']);
Route::post('/appointments/store', [PatientsController::class, 'store'])->name('appointments.store');
Route::get('/appointments/{patient}', [PatientsController::class, 'show']);
Route::get('/appointments/{patient}/edit', [PatientsController::class, 'edit']);
Route::put('/appointments/{patient}', [PatientsController::class, 'update'])->name('appointments.update');
Route::delete('/appointments/{patient}', [PatientsController::class,'destroy']);
