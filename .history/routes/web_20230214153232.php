...
Route::get('/appointments/{patient}/edit', [AppointmentController::class, 'edit']);
Route::put('/appointments/{patient}', [AppointmentController::class, 'update'])->name('appointments.update');
