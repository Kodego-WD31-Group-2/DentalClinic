...
// Define a route to retrieve the transaction data from the server
Route::get('/transactions', function () {
    $transactions = DB::table('transactions')
        ->select(DB::raw('DATE(transaction_date) as date'), DB::raw('COUNT(*) as count'), DB::raw('SUM(total_cost) as total_payments'))
        ->groupBy('date')// Order by date in ascending order
        ->orderBy('date', 'ASC')
        ->get();
