...
(function () {
    ...
    if ($("#payment-method-chart").length) {
        // Retrieve the payment method transaction data from the server
        $.get('/payment-methods', function (data) {
            let ctx = $("#payment-method-chart")[0].getContext("2d");
            let myChart = new Chart(ctx, {
                type: "pie",
                data: {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Payment Method Transactions',
                        }
                    }
                },
            });
