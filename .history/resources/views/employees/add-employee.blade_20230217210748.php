                ...
                <div id="horizontal-form" class="p-5">
                    <div class="preview">                        
                        ...
                        <div class="form-inline">
                            <label for="first_name" class="form-label sm:w-20 my-21">First Name:</label>
                            <input id="first_name" type="text" class="form-control" placeholder="example@gmail.com">
                        </div>
                        <div class="form-inline">
                        ...
                        <div class="form-inline">
                            <label for="horizontal-form-1" class="form-label sm:w-20">Position:</label>
                            <input id="horizontal-form-1" type="text" class="form-control" placeholder="example@gmail.com">
                        </div>
                        <div class="form-inline">
