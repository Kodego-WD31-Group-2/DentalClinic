                ...
                <div class="box">
                    <div class="flex flex-col lg:flex-row items-center p-5">
                        <div class="w-24 h-24 lg:w-12 lg:h-12 image-fit lg:mr-1">
                            <img  class="rounded-full" src="{{ file_exists(public_path('storage/' . $employee->employee_image)) ? asset('storage/' . $employee->employee_image) : asset($employee->employee_image) }}" width="200">
                        </div>
                        ...
                        <div class="flex mt-4 lg:mt-0">
                            ...
                            <form action="{{ url('employees/'.$employee->id) }}" method="POST">
                                <a class="btn btn-secondary" href="{{ url('employees/'.$employee->id.'/edit') }}">Edit</a>
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn bg-red-100">Delete</button>
                            </form>
