      ...
      <div class="block rounded-lg shadow-lg bg-white">
        <div class="flex flex-wrap items-center">
          <div class="grow-0 shrink-0 basis-auto block lg:flex w-full lg:w-6/12 xl:w-4/12">
            <img src="https://source.unsplash.com/random/320x240/?dental+clinic+blue" alt="Dental"
                ...
                <div id="horizontal-form" class="p-5">
                    <div class="preview">                        
                        ...
                        <div class="form-inline">
                            ...
                            <input id="last_name" type="text" class="form-control my-2" placeholder="example@gmail.com">
                        </div>
                        <div class="form-inline">
                            <label for="position" class="form-label sm:w-20 my-2">Position:</label>
                            <input id="position" type="text" class="form-control my-2" placeholder="example@gmail.com">
                        </div>
