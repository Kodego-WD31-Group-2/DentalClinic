        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    <img alt="Midone - HTML Admin Template" class="w-6" src="{{ asset('assets/img/logo-1.png')}}">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="intro-x mt-8">
                            ...
                            <p class="text-red-500">{{ $message }}</p>
                            @enderror
                            <input type="text" name="password" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password" value="{{ old('password') }}">
                            @error('password')
                            <p class="text-red-500">{{ $message }}</p>
                            @enderror
                            <input type="text" name="password_confirmation" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password Confirmation" value="{{ old('password_confirmation') }}">
                ...
                @enderror
                            ...
                            <div class="intro-x mt-8">
                                <div>Gender:</div>
                                <input type="radio" name="gender" value="male" class="form-check-input mr-2" {{ old('gender') == 'male' ? 'checked' : '' }}>
                                <label class="cursor-pointer select-none">Male</label>

                                <input type="radio" name="gender" value="female" class="form-check-input mr-2 ml-4" {{ old('gender') == 'female' ? 'checked' : '' }}>
                                <label class="cursor-pointer select-none">Female</label>
