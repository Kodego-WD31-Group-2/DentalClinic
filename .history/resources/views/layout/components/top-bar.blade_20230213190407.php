        ...
        <div class="flex items-center lg:ml-auto">
            <a href="/login">
              <button
                ...
                data-mdb-ripple-color="light"
              >
                <span class="iconize sm:inline">Login</span>
                <i class="fas fa-sign-in-alt sm:inline"></i>
              </button>
            </a>
            <a href="/register">
              <button
                ...
                data-mdb-ripple-color="light"
              >
                <span class="iconize sm:inline">Sign Up</span>
                <i class="fas fa-user-plus sm:inline"></i>
              </button>
            </a>
            <a href="/appointment">
              <button
                ...
                data-mdb-ripple-color="light"
              >
                <span class="iconize sm:inline">Book an Appointment</span>
                <i class="fas fa-calendar-alt sm:inline"></i>
              </button>
            </a>
          </div>
