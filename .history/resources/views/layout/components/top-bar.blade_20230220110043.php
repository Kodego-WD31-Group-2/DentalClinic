                ...
                <div class="search-result__content">
                    ...
                    <div class="mb-5">
                        <a href="/doctors" class="flex items-center">
                            ...
                            <div class="ml-3">Doctors</div>
                        </a>
                        <a href="/services" class="flex items-center mt-2">
                            <div class="w-8 h-8 bg-pending/10 text-pending flex items-center justify-center rounded-full">
                                <i class="w-4 h-4" data-lucide="shopping-cart"></i>
                            </div>
                            <div class="ml-3">Services</div>
                        </a>
                        <a href="/appointments/book-appointment" class="flex items-center mt-2">
                            <div class="w-8 h-8 bg-primary/10 dark:bg-primary/20 text-primary/80 flex items-center justify-center rounded-full">
                                <i class="w-4 h-4" data-lucide="book"></i>
                            </div>
                            <div class="ml-3">Book an Appointments</div>
                        </a>
                    </div>
