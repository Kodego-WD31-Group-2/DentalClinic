...
<div class="top-bar-boxed {{ isset($class) ? $class : '' }} h-[70px] md:h-[65px] z-[51] border-b border-white/[0.08] mt-12 md:mt-0 -mx-3 sm:-mx-8 md:-mx-0 px-3 md:border-b-0 relative md:fixed md:inset-x-0 md:top-0 sm:px-8 md:px-10 md:pt-10 md:bg-gradient-to-b md:from-slate-100 md:to-transparent dark:md:from-darkmode-700">
    <div class="h-full flex items-center">
        ...
        <!-- END: Logo -->
        <div class="intro-x navbar-collapse collapse grow items-center" id="navbarSupportedContentY">
            <ul class="intro-x navbar-nav mr-auto lg:flex lg:flex-row">
              <li class="intro-x nav-item">
                <a
                  class="intro-x nav-link block pr-2 lg:px-2 py-2 text-white rounded-lg hover:bg-blue-200 hover:text-blue-900 focus:text-blue-900 transition duration-150 ease-in-out"
                  href="/"
        ...
        <div class="intro-x flex items-center lg:ml-auto">
          <a href="/login">
            <button
            type="button"
