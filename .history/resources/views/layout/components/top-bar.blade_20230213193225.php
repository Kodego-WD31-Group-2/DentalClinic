      ...
      <div class="px-6 w-full flex flex-wrap items-center justify-between">
        ...
        <div class="flex items-center lg:ml-auto">
            <a href="/login">
              <button
                type="button"
                class="inline-block px-6 py-2.5 mr-2 bg-white text-blue-600 font-medium text-xs leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out hidden sm:inline-block"
                data-mdb-ripple="true"
                data-mdb-ripple-color="light"
              >
                
              <i class="fas fa-sign-in-alt sm:inline-block"></i>Login
              </button>
            </a>
            <a href="/register">
              <button
                type="button"
                class="inline-block px-6 py-2.5 mr-2 bg-blue-300 text-white font-medium text-xs leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out hidden sm:inline-block"
                data-mdb-ripple="true"
                data-mdb-ripple-color="light"
              >
                Sign Up
              </button>
              <i class="fas fa-user-plus sm:inline-block"></i>
            </a>
            <a href="/appointment">
              <button
                type="button"
                class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out hidden sm:inline-block"
                data-mdb-ripple="true"
                data-mdb-ripple-color="light"
              >
                Book an Appointment
              </button>
              <i class="fas fa-calendar-alt sm:inline-block"></i>
            </a>
          </div>
