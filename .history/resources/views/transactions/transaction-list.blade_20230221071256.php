            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    @foreach ($transactions as $transaction)
                            <tr class="intro-x">
                                <td>
                                    <a href="" class="font-medium whitespace-nowrap">{{ $transaction->feeSchedule->name }}</a>
                                    <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{ $transaction->feeSchedule->description }}</div>
                                </td>
                                <td class="text-center">{{ $transaction->transaction_id }}</td>
                                <td class="text-center">{{ $transaction->feeSchedule->amount }}</td>
