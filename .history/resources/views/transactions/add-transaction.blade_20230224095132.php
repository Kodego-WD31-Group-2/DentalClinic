            ...
            <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 bg-custom-2 py-24 px-24 rounded">
                ...
                <form method="POST" action="{{ route('transactions.store') }}">
                    ...
                    <div class="p-2.5">
                        <button
                    type="button"
                    class="inline-block mt-3 rounded border-2 bgborder-custom-1 px-6 pt-2 pb-[6px] text-xs font-medium uppercase leading-normal text-light transition duration-150 ease-in-out hover:border-primary-600 hover:bg-neutral-500 hover:bg-opacity-50 hover:text-primary-600 focus:border-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:border-primary-700 active:text-primary-700 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10"
                    data-te-ripple-init>
                    Submit
                    </button>
                    </div>
