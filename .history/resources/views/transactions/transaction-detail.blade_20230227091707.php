    ...
    <div class="intro-y grid grid-cols-11 gap-5 mt-5">
        <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
            ...
            <div class="box p-5 rounded-md mt-5">
                <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
                    <div class="font-medium text-base truncate">Appointmment Details</div>
                    <a href="" class="flex items-center ml-auto text-primary">
                ...
                <div class="flex items-center mt-3">
                    <i data-lucide="calendar" class="w-4 h-4 text-slate-500 mr-2"></i> Phone Number: {{ $transaction->appointment->first_name }} 
                </div>
                <div class="flex items-center mt-3">
                    <i data-lucide="map-pin" class="w-4 h-4 text-slate-500 mr-2"></i> Email Address: 260 W. Storm Street New York, NY 10025.
                </div>
            </div>
            <div class="box p-5 rounded-md mt-5">
                <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
                        ...
                        <tbody>
                            @foreach($transaction->transactionItems as $transactionItem)
                                <tr>
                                    ...
                                    <td class="text-center">${{ $transactionItem->cost }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
