            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    @foreach ($s as $)
                            <tr class="intro-x">
                                <td>
                                    <a href="" class="font-medium whitespace-nowrap">{{ $->feeSchedule->name }}</a>
                                    <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{ $->feeSchedule->description }}</div>
                                </td>
                                <td class="text-center">{{ $->transaction_id }}</td>
                                <td class="text-center">{{ $->feeSchedule->amount }}</td>
                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3" href="{{ route('transactions.edit', $->id) }}">
