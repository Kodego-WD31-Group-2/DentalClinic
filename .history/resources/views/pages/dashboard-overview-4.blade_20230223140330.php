            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-6 mt-8">
                    ...
                    <div class="intro-y box p-5 mt-5">
                        <div class="mt-3">
                            <div class="h-[213px]">
                                <canvas id="report-donut-chart" data-minors-percentage="{{ $minorPercentage }}" data-adults-percentage="{{ $adultPercentage }}" data-seniors-percentage="{{ $seniorPercentage }}"></canvas>
                            </div>
                        </div>
                        <div class="w-52 sm:w-auto mx-auto mt-8">
                            <div class="flex items-center">
