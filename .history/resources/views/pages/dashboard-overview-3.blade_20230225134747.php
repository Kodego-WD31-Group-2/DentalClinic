    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 text-center">Today's Total Payments</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 text-center">Completed Payments</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 text-center">Failed Payments</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- BEGIN: Overall Payment Overview -->
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center h-10">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        ...
                        <div class="report-chart">
                            <div class="h-[275px]">
                                ...
                                data-prevmonth-count="{{ $appointmentsPreviousMonth }}" data-thismonth-count="{{ $appointmentsThisMonth }}" data-nextmonth-count="{{ $appointmentsNextMonth }}"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
