                ...
                <div class="intro-y box col-span-12 lg:col-span-6">
                    ...
                    <div class="p-5">
                        @foreach ($appointments as $appointment)
                            @if ($appointment->usewrid == Auth::id() && $appointment->status == 'Pending')
                                <div class="flex flex-col sm:flex-row">
                                    <div class="mr-auto">
                                        <a href="" class="font-medium">{{ $appointment->appointment_date->format('M d, Y') }}</a>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="text-center">
                                            <div class="font-medium">{{ $appointment->first_name }}</div>
                                            <div class="bg-success/20 text-success rounded px-2 mt-1.5">{{ $appointment->status }}</div>
                                        </div>
                                    </div>
                                </div>
                            @endif
