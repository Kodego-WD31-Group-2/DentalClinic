            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 lg:col-span-6 mt-8">
                    <div class="intro-y block sm:flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Paym by Month</h2>
                    </div>
                ...
                <!-- resources/views/pages/dashboard-overview-3.blade.php -->
...
<script>
    $(function() {
        // Define a function to retrieve the payment method data from the server
        ...
        if ($('#payment-methods-chart').length) {
            let ctx = $('#payment-methods-chart')[0].getContext('2d');
            ...
            // Retrieve the payment method data and update the chart
            getPaymentMethodData().then(function(data) {
