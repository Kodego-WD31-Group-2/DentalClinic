                    ...
                    <div class="p-5">
                        ...
                        <div class="relative flex items-center mt-4">
                            <div class="w-12 h-12 flex-none image-fit">
                                <img alt="{{ $patient->first_name }} {{ $patient->last_name }}" class="rounded-full" src="{{ $patient->profile_image_url }}">
                            </div>
                            <div class="ml-4 mr-auto">
                                <a href="{{ route('patients.show', $patient->id) }}" class="font-medium">{{ $patient->first_name }} {{ $patient->last_name }}</a>
