                    ...
                    <div class="p-5">
                        ...
                        <div class="relative flex items-center mt-4">
                            <div class="w-12 h-12 flex-none image-fit">
                                <img alt="{{ $patient->first_name }} {{ $patient->last_name }}" class="rounded-full" src="{{ file_exists(public_path('storage/' . $patient->patient_name)) ? asset('storage/' . Auth::user()->photo) : asset(Auth::user()->photo) }}">
                            </div>
