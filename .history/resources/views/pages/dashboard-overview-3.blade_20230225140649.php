                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 text-center">{{ $paidTransactions->count() }} Completed Payments</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        ...
                        <div class="mt-3">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-0 text-center">
                                        {{-- {{ $totalPatients }} --}}
                                    </div>
