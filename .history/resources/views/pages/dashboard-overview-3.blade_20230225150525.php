    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 text-center">
                                        {{ $paidTransactionsToday->count() + $pendingTransactionsToday->count() + $failedTransactionsToday->count() }} Today's Total Payments
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Over all Billing Summary</h2>
                        <a href="" class="ml-auto flex items-center text-primary">
                            <i data-lucide="refresh-ccw" class="w-4 h-4 mr-3"></i> Reload Data
                        </a>
                    </div>
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 text-center">
                                        {{ $paidTransactions->count() + $pendingTransactions->count() + $failedTransactions->count() }} 's Total Payments
                                    </div>
                                </div>
                            </div>
                        </div>
