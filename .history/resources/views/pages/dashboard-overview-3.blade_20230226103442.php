...
@section('subcontent')
    ...
    <canvas id="transaction-line-chart" width="400" height="150"></canvas>
@endif
...
<script>
    $(function() {
        ...
        if ($("#transaction-line-chart").length) {
            let ctx = $("#transaction-line-chart")[0].getContext("2d");
            let myChart = new Chart(ctx, {
                type: "line",
                data: {
                    labels: transactions.map(t => t.transaction_date),
                    datasets: [
                        {
                        ...
                        },
                        {
                            ...
                            data: transactions.map(t => t.total_payments),
                            borderWidth: 2,
                            borderColor: colors.warning(0.8),
                            backgroundColor: "transparent",
                            pointBorderColor: "transparent",
                            tension: 0.4,
                        },
