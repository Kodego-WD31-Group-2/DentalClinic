            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-6 mt-8">
                    ...
                    <div class="intro-y box p-5 mt-5">
                        <div class="mt-3">
                            <div class="h-[213px]">
                                <canvas id="report-pie-chart" data-regularcheckup-percentage="{{ $malePercentage }}" data-emergency-percentage="{{ $femalePercentage }}" data-cleaning-percentage="{{ $cleaningPercentage }}">></canvas>
                            </div>
                        </div>
