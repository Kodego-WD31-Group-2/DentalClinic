                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 text-center">{{ $paidTransactions->count() + $pendingTransactions->count() + $failedTransactions->count() }}Today's Total Payments</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
