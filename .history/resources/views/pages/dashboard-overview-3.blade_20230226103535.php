...
<script>
    // chart data
    var chartData = {
        labels: {!! json_encode($transactionsData->pluck('date')->toArray()) !!},
        datasets: [{
            label: 'Transaction Count',
            data: {!! json_encode($transactionsData->pluck('transactions')->toArray()) !!},
            borderWidth: 2,
            borderColor: 'blue',
            ...
            data: {!! json_encode($transactionsData->pluck('total_payments')->toArray()) !!},
            borderWidth: 2,
            borderColor: 'green',
            backgroundColor: 'transparent',
            pointBorderColor: 'transparent',
