<div class="flex flex-col md:flex-row md:space-x-4">
  <div class="flex-1">
    <div class="form-group">
      <label for="appointment_date" class="block text-sm font-medium text-blue-600 p-2">Preferred Appointment Date:</label>
      <input type="date" id="appointment_date" name="appointment_date" class="mt-1 block w-full border-blue-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500" value="{{ old('appointment_date') }}" required>
    </div>
    <div class="form-group">
      <label for="appointment_time" class="block text-sm font-medium text-blue-600 p-2">Preferred Appointment Time:</label>
  ...
  <div class="flex-1">       
    <div class="form-group">
      <label for="doctor_id" class="block text-sm font-medium text-blue-600 p-2">Doctor's Name:</label>
    ...
    <div class="form-group">
      <label for="appointment_type" class="block text-sm font-medium text-blue-600 p-2">Type of Appointment:</label>
...
<div class="form-group">
  <label for="reason" class="block text-sm font-medium text-blue-600 p-2">Reason for Appointment:</label>
  <textarea id="reason" name="reason" class="form-textarea mt-1 block w-full border-blue-300 focus:border-blue-500 rounded-md shadow-sm" required>{{ old('reason') }}</textarea>
</div>
<div class="form-group">
  <label for="dental_history" class="block text-sm font-medium text-blue-600 p-2">Previous Dental History:</label>
