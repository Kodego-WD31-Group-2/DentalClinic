      ...
      <div class="flex flex-wrap items-center bg-custom-1 p-10 rounded">
        <div class="grow-0 shrink-0 basis-auto block lg:flex w-full lg:w-6/12 xl:w-4/12 bg-blue-800 flex justify-center p-20 rounded">
          <div class="tab-headers flex border-b border-gray-300">
            <div class="tab-header rounded active cursor-pointer px-4 py-2  font-medium" data-tab="1">Appointment Information</div>
            <div class="tab-header rounded cursor-pointer px-4 py-2  font-medium" data-tab="2">Patient Information</div>
            <div class="tab-header rounded cursor-pointer px-4 py-2  font-medium" data-tab="3">Contact Information</div>
            <div class="tab-header rounded cursor-pointer px-4 py-2  font-medium" data-tab="4">Additional Information</div>
            <div class="tab-header rounded cursor-pointer px-4 py-2  font-medium" data-tab="5">Confirmation</div>
          </div>
        </div>
