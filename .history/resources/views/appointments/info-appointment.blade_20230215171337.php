<div class="flex flex-col md:flex-row md:space-x-4">
  <div class="flex-1">
    <div class="form-group">
      <label for="appointment_date" class="block text-sm font-medium text-custom p-2">Preferred Appointment Date:</label>
    ...
    <div class="form-group">
      <label for="appointment_time" class="block text-sm font-medium text-custom p-2">Preferred Appointment Time:</label>
  ...
  <div class="flex-1">       
    <div class="form-group">
      <label for="doctor_id" class="block text-sm font-medium text-custom p-2">Doctor's Name:</label>
    ...
    <div class="form-group">
      <label for="appointment_type" class="block text-sm font-medium text-custom p-2">Type of Appointment:</label>
...
<div class="form-group">
  <label for="reason" class="block text-sm font-medium text-custom p-2">Reason for Appointment:</label>
...
<div class="form-group">
  <label for="dental_history" class="block text-sm font-medium text-custom p-2">Previous Dental History:</label>
