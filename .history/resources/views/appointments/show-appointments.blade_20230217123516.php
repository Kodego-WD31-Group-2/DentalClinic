                        ...
                        <tr class="intro-x">
                            ...
                            <td class="w-40">
                                <div class="flex items-center justify-center">
                                    <select class="form-select mt-2 sm:mr-2" name="status" aria-label="Default select example" onchange="this.form.submit()" action="{{ route('appointments.status', $appointment->id) }}">
