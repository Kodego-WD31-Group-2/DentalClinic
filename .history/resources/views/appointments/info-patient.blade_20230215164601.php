...
<div class="flex flex-col md:flex-row md:space-x-4">
  <div class="flex-1">
    <div class="form-group">
      ...
      <input type="text" name="first_name" class="form-text mt-1 block w-full border-blue-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500" value="{{ old('first_name') }}" required>
    </div>
    <div class="form-group">
      <label for="last_name" class="block text-sm font-medium text-blue-600 p-2">Last Name:</label>
      <input type="text" name="last_name" class="mt-1 block w-full border-blue-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500" value="{{ old('last_name') }}" required>
    </div>
  </div>
  <div class="flex-1">
    <div class="form-group">
