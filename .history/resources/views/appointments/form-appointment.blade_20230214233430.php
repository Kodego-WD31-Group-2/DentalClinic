  ...
  <div class="mb-4">
    ...
    <textarea class="w-full border border-gray-400 p-2" id="medical-conditions" name="medical-conditions">test</textarea>
                ...
                <div class="tab" data-tab="3">
                  ...
                  <div class="mb-4">
                    <label value="test" class="block text-gray-700 font-medium mb-2" for="emergency-contact-name">
                ...
                <div class="tab" data-tab="4">
                  ...
                  <div class="mb-6">
                    ...
                    <input value="828-203-8204" class="border border-gray-400 p-2 rounded-lg w-full" type="text" id="referral-source" name="referral-source">
                  </div>
                  <div class="mb-6">
