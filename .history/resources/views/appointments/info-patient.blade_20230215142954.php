...
<div class="form-group">
  ...
  <input class="form-control" required type="date" id="dob" name="dob" value="{{ old('dob') }}">
</div>
...
<div class="form-group">
  ...
  <textarea class="form-control" required id="medications" name="medications">{{ old('medications') }}</textarea>
</div>
<div class="form-group">
  <label class="block font-medium mb-2" for="allergies">Allergies (if any):</label>
  <textarea class="form-control" required id="allergies" name="allergies">{{ old('allergies') }}</textarea>
</div>
<div class="form-group">
  <label class="block font-medium mb-2" for="medical_conditions">Medical conditions that may affect dental treatment:</label>
  <textarea class="form-control" required id="medical_conditions" name="medical_conditions">{{ old('medical_conditions') }}</textarea>
</div>
