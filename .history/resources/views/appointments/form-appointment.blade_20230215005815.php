            ...
            <div class="tab-content mt-6">
                ...
                <div class="tab" data-tab="2">
                  ...
                  <div class="mt-4">
                    ...
                    <select id="gender" name="appointment-time" class="mt-2 border border-gray-400 rounded p-2 w-full">
                      <option value="morning">Morning</option>
                      <option value="afternoon">Afternoon</option>
                    </select>
                  </div>
                ...
                <div class="tab" data-tab="4">
                  ...
                  <div class="mb-6">
                    ...
                    <textarea class="border border-gray-400 p-2 rounded-lg w-full" id="special-instructions" name="special-instructions">test</textarea>
                  </div>
                  <div class="mb-6">
                    <label class="block font-medium mb-2" for="referral-source">Referral source (if referred by another individual or office):</label>
                    <input value="test" class="border border-gray-400 p-2 rounded-lg w-full" type="text" id="referral-source" name="referral-source">
                  </div>
                  <div class="mb-6">
