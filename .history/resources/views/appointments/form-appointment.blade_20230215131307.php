...
@section('subcontent')
    <div class="container">
        ...
        <form method="POST" action="{{ route('appointments.store') }}">
          ...
          <div class="form-group">
            <label for="appointmenttype" class="text-sm font-medium">Type of Appointment:</label>
            <select id="appointmenttype" name="appointmenttype" class="mt-2 border border-gray-400 rounded p-2 w-full">
