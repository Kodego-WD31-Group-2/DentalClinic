    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('appointments.store') }}">
          ...
          <div class="form-group">
            ...
            <input value="2023-02-23" type="date" id="appointment_date" name="appointment_date" class="mt-2 border border-gray-400 rounded p-2 w-full">
          </div>
          <div class="form-group">
            ...
            <select id="appointment_time" name="appointment_time" class="mt-2 border border-gray-400 rounded p-2 w-full">
              <option value="orning">Morning</option>
