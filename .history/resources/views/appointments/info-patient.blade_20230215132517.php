...
<div class="form-group">
  <label class="block font-medium mb-2" for="medicalconditions">Medical conditions that may affect dental treatment:</label>
  <textarea class="w-full border border-gray-400 p-2" id="medicalconditions" name="medicalconditions">test</textarea>
</div>