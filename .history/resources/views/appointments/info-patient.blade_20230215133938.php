...
<div class="form-group">
  ...
  <textarea class="form-control" required id="medications" name="medications"></textarea>
</div>
<div class="form-group">
  <label class="block font-medium mb-2" for="allergies">Allergies (if any):</label>
  <textarea class="form-control" required id="allergies" name="allergies"></textarea>
</div>
<div class="form-group">
  <label class="block font-medium mb-2" for="medical_conditions">Medical conditions that may affect dental treatment:</label>
  <textarea class="form-control" required id="medical_conditions" name="medical_conditions">test</textarea>
</div>