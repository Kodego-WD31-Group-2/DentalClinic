...
<div class="mb-4">
  ...
  <textarea id="reason" name="reason" class="form-textarea mt-1 block w-full border-blue-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>{{ old('reason') }}</textarea>
</div>
<div class="mb-4">
  <label for="dental_history" class="block text-sm font-medium text-blue-600">Previous Dental History:</label>
  <textarea id="dental_history" name="dental_history" class="form-textarea mt-1 block w-full border-blue-300 focus
