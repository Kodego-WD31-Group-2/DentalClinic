<div class="container my-24 px-6 mx-auto">
          ...
          <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
            <div class="px-6 py-12 md:px-12">
              <div class="tab-content mt-6">
                <form method="post" action="http://127.0.0.1:8000/appointments/store">
                  <input type="hidden" name="_token" value="JXx6KjBoTFPh2nXFpvHceKxJnTWFGiSXRQqMQWqz">                <div class="tab active" data-tab="1">
                    <div class="mt-4">
  ...
  <div class="mt-4">
    ...
    <div class="mb-4">
      ...
      <input class="w-full border border-gray-400 p-2" type="text" id="first-name" name="first-name">
    </div>
    <div class="mb-4">
      <label class="block font-medium mb-2" for="last-name">Last Name:</label>
      <input class="w-full border border-gray-400 p-2" type="text" id="last-name" name="last-name">
    </div>
    <fieldset class="mb-4">
    ...
    <div class="mb-4">
      ...
      <input class="w-full border border-gray-400 p-2" type="date" id="dob" name="dob">
    </div>
  ...
  <h3 class="text-lg font-medium mt-6">Medical Information:</h3>
    <div class="mb-4">
      ...
      <textarea class="w-full border border-gray-400 p-2" id="medications" name="medications"></textarea>
    </div>
    <div class="mb-4">
      <label class="block font-medium mb-2" for="allergies">Allergies (if any):</label>
      <textarea class="w-full border border-gray-400 p-2" id="allergies" name="allergies"></textarea>
    </div>
    <div class="mb-4">
      <label class="block font-medium mb-2" for="medical-conditions">Medical conditions that may affect dental treatment:</label>
      <textarea class="w-full border border-gray-400 p-2" id="medical-conditions" name="medical-conditions"></textarea>
    </div>                  <button type="button" class="prev-btn bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded">Previous</button>
                    <button type="button" class="next-btn bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded">Next</button>
                  </div>
