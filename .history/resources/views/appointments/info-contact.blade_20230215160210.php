<div class="form-group mb-4">
  <label class="block text-blue-600 font-medium mb-2" for="phone_number">
    Phone Number:
  </label>
...
<div class="form-group mb-4">
  <label class="block text-blue-600 font-medium mb-2" for="email">
    Email Address:
  </label>
...
<div class="form-group mb-4">
  <label class="block text-blue-600 font-medium mb-2" for="emergency_contact_name">
...
<div class="form-group mb-4">
  <label class="block text-blue-600 font-medium mb-2" for="emergency_contact_number">
