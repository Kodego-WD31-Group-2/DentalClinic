          ...
          <div class="px-6 py-12 md:px-12">
            ...
            <div class="tab-content mt-6">
                ...
                <div class="tab active" data-tab="1">
                  @include('appointments.info-appointment') 
                  {{--  --}}
                  <button type="button" class="next-btn bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded mt-2">Next</button>
                </div>
                <div class="tab" data-tab="2">
                  @include('appointments.info-patient')
                  {{--  --}}
                  <button type="button" class="prev-btn bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded mt-2">Previous</button>
                  <button type="button" class="next-btn bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded mt-2">Next</button>
                </div>
                ...
                <div class="tab" data-tab="5">
                  ...
                  {{--  --}}
                  <button type="button" class="prev-btn bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-4 rounded mt-2">Previous</button>
                  <button type="submit" class="submit-btn bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded mt-2">Submit</button>
                </div>
            </div>
          </form>
