<div class="flex flex-col md:flex-row md:space-x-4">
   ...
   <div class="flex-1">       
     ...
     <div class="form-group">
      <label for="doctor_id" class="block text-sm font-medium text-custom-2 p-2">Doctor's Name:</label>
      <input class="form-control block w-full p-2 border rounded-md shadow-sm" required type="text" id="doctor_id" name="doctor_id" value="{{ old('doctor_id', $appointment->doctor_id) }}">
