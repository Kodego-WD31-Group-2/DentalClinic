...
<div class="container my-24 px-6 mx-auto">
  ...
  <section class="mb-32 text-gray-800 text-center md:text-left">
    <div class="block rounded-lg shadow-lg bg-gray-800">
      <div class="flex flex-wrap items-center bg- p-10 rounded">
            ...
            <form action="{{ route('appointments.store') }}" method="post" enctype="multipart/form-data">
              <div class="tab-content mt-6">
                ...
                <div class="tab active" data-tab="1">
                  @include('appointments.info-appointment') 
                  {{--  --}}
                  <button type="button" class="next-btn bg- hover:bg-blue-800 text-white font-medium py-2 px-4 rounded mt-3">Next</button>
                </div>
                <div class="tab" data-tab="2">
                  @include('appointments.info-patient')
                  {{--  --}}
                  <button type="button" class="prev-btn bg- hover:bg-blue-800 text-white font-medium py-2 px-4 rounded mt-3">Previous</button>
                  <button type="button" class="next-btn bg- hover:bg-blue-800 text-white font-medium py-2 px-4 rounded mt-3">Next</button>
                </div>
