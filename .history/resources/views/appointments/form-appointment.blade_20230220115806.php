...
<div>
  ...
  <section> 
    <div class="text-center bg-gray-50 text-gray-800 py-5 pt-10 px-6">
      <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">Book an Appointment</h1>
    </div>
  </section>
  <!-- Section: Design Block -->
