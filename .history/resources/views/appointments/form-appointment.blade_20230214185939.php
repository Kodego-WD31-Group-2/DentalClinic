...
<script>
  ...
  function showTab(n) {
    ...
    if (n == (tabs.length - 1)) {
      nextBtns[n].innerHTML = "Submit";
    } else {
      nextBtns[n].innerHTML = "Next";
    }
  }
  ...
  // Define the function to navigate to the next tab
  function nextTab() {
    hideTab(activeTab);
    activeTab++;
  ...
  // Define the function to navigate to the previous tab
  function prevTab() {
    hideTab(activeTab);
    activeTab--;
    showTab(activeTab);
