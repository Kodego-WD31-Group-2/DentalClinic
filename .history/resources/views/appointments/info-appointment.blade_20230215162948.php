<div class="flex flex-col md:flex-row md:space-x-4">
  <div class="flex-1">
    <div class="form-group">
      ...
      <input type="date" id="appointment_date" name="appointment_date" class="form-control border-blue-300 focus:ring-blue-500 focus:border-blue-500" value="{{ old('appointment_date') }}" required>
    </div>
    <div class="form-group">
