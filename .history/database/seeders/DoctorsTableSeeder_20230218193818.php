...
class DoctorsTableSeeder extends Seeder
{
    ...
    {
        $images = ['7YVZYZeITc8', 'iFgRcqHznqg', 'ILip77SbmOE','Endodontist', 'QXevDflbl8A', '', 'Zz5LQe-VSMY', 'WMD64tMfc4k', 'pAtA8xe_iVM', 'SJvDxw0azqw'];

        $imageCount = count($images);
        for ($i = 0; $i < 10; $i++) {
            $imageIndex = $i % $imageCount;
            $image = $images[$imageIndex];
            $displayImage = "https://imageunsplash.com/photos/{$image}";
