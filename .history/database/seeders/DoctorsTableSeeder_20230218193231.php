...
class DoctorsTableSeeder extends Seeder
{
    ...
    {
        $images = ['7YVZYZeITc8', 'iFgRcqHznqg', 'dental+staff','Endodontist', 'Orthodontist', 'Oral and Maxillofacial Surgeon', 'Pediatric Dentist', 'Periodontist', 'Prosthodontist'];

        $imageCount = count($images);
        for ($i = 0; $i < 10; $i++) {
            $imageIndex = $i % $imageCount;
            $image = $images[$imageIndex];
            $displayImage = "https://unsplash.com/photos/{$image}";
