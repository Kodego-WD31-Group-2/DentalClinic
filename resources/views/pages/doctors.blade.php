    ...
    <section>
      ...
      <div class="container mx-auto px-6 md:px-6 xl:px-16" >
        <div class="text-center text-gray-800">
          <div class="block rounded-lg shadow-lg px-6 md:py-16 md:px-12" style="margin-top: 50px; background-color: hsla(0, 0%, 100%, 0.8);backdrop-filter: saturate(200%) blur(25px);">
