...
<section class="bg-white ">
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p class="mb-8 lg:mb-16 font-light text-center dark:text-black-400 sm:text-xl">Want to send feedback about us?Let us know.</p>
        <form action="#" class="space-y-8">
            <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black-300">Your Name</label>
