...
@section('head')
    <title>Login - Smileville Dental Services</title>
@endsection
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="z-50 h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-2 text-dark-500 xl:hidden text-center">A few more clicks to sign in to your account. <br> Experience quality dental care that lasts a lifetime.</div>
                    ...
                    <div class="intro-x mt-10 xl:mt-24 text-slate-600 dark:text-slate-500 text-center xl:text-left">
                        By signin up, you agree to our <a class="text-primary dark:text-700" href="">Terms and Conditions</a> & <a class="text-primary dark:text-700" href="">Privacy Policy</a>
                    </div>
                </div>
            </div>
            <!-- END: Login Form -->
