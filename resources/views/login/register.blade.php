    ...
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="z-50 h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-costum-2 dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
