        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-custom-1 font-medium text-4xl leading-tight mt-10">Healthy teeth, happy life</div>
                    <div class="-intro-x text-custom-1 font-medium text-3xl leading-tight mt-1">smile with confidence at our dental clinic.</div>
                    <div class="-intro-x mt-5 text-lg text-custom-2 text-opacity-70 dark:text-slate-400">Creating lasting smiles with quality care.</div>
                </div>
            </div>
            <!-- END: Register Info -->
            <!-- BEGIN: Register Form -->
            <div class="z-50 h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-costum-2 dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
